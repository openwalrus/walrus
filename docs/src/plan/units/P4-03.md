...
- Subcommands: Chat, Send, Agent, Memory, Config.
...
- **REWRITE** `app/cli/Cargo.toml` — depends on walrus-runtime, walrus-core,
  walrus-llm, clap, tokio, anyhow, tracing
- **REWRITE** `app/cli/src/lib.rs` — Cli struct, Command enum
