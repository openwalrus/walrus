...
- **MODIFY** `crates/core/Cargo.toml` — add futures-core, anyhow dependencies
...
- **ChannelMessage**: platform, channel_id (`CompactString`), sender_id (`CompactString`), content, attachments, reply_to, timestamp.
