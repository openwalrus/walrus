...
pub use crate::protocol::proto::{
    ...
    ErrorMsg, GetConfig, HubAction, HubMsg, KillMsg, KillTaskMsg, Ping, Pong, SendMsg,
    SendResponse, ServerMessage, ServiceQueryMsg, ServiceQueryResultMsg, SessionInfo, SessionList,
    SetConfigMsg, StreamChunk, StreamEnd, StreamEvent, StreamMsg, StreamStart, StreamThinking,
